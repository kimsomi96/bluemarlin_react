    ...
    return(
        <div id="content">
            ...
            <div className="container">
                <div className="row">
                    <div className="col-xs-12 col-md-10 col-md-offset-1 title-box">
                ...
                <form>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-10 col-md-offset-1 form-group">
                            <label htmlFor="dataperday">일간 데이터량(GB)</label>
                            <input type="text" className="form-control" id="dataperday" name="dataperday"
                                   placeholder="일간 데이터량(GB)"/>
                        </div>
                        <div className="col-md-10 col-md-offset-1 form-group">
                            <label htmlFor="purpose">활용목적</label>
                            <input type="text" className="form-control" id="purpose" name="purpose" placeholder="활용목적"/>
                        </div>
                        <div className="col-md-10 col-md-offset-1 form-group">
                            <button type="submit" className="btn btn-primary btn-lg pull-right">데모 신청하기</button>
